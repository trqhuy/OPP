...
//    ofstream outputFile(ATMFileName, ios::app);
//    if (outputFile.is_open()) {
//        outputFile << idATM << "," << fixed << setprecision(0) << soDuATM << "," << diaChi << "," << (trangThaiHoatDong ? "Hoat Dong" : "Khong Hoat Dong") << endl;
//        outputFile.close();
//    } else {
//        cout << "Khong the mo file de ghi!" << endl;
//    }
...
//    cout << "So tien: " << fixed << setprecision(2) << amount << " VND" << endl;
//    cout << "So du sau giao dich: " << fixed << setprecision(2) << Cust.soDu << " VND" << endl;
//    cout << "-----------------------------------------------------" << endl;
//}
//
//void ATM::capNhatSoDuATM() {
